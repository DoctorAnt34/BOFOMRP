...
#TODO HMI dan veri çekme eklenecek.
...
def db_update():
    uretim_kod_list = list()

    for i in list(uretim.keys()):
        uretim_kod_list.append(i)
    
    for i in list(aktif_uretim.keys()):
          uretim_kod_list.append(i)
    
    for i in uretim_kod_list:
          uretim_giris(i)
    
    bag_kod_list = list()

    for i in list(bag_veri.keys()):
          bag_kod_list.append(i)

    for i in bag_kod_list:
          bag_giris(i)
          isi_giris(i)      
